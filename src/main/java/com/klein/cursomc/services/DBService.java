...
import com.klein.cursomc.domain.Endereco;
import com.klein.cursomc.domain.Estado;
import com.klein.cursomc.domain.ItemPedido;
import com.klein.cursomc.domain.Pagamento;
import com.klein.cursomc.domain.PagamentoComBoleto;
import com.klein.cursomc.domain.PagamentoComCartao;
import com.klein.cursomc.domain.Pedido;
import com.klein.cursomc.domain.Produto;
import com.klein.cursomc.domain.enums.EstadoPagamento;
import com.klein.cursomc.domain.enums.Perfil;
import com.klein.cursomc.domain.enums.TipoCliente;
...
import com.klein.cursomc.repositories.EnderecoRepository;
import com.klein.cursomc.repositories.EstadoRepository;
import com.klein.cursomc.repositories.ItemPedidoRepository;
import com.klein.cursomc.repositories.PagamentoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "363786912377", TipoCliente.PESSOAFISIA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Silvia", "ana@gmail.com", "45957393037", TipoCliente.PESSOAFISIA, pe.encode("123"));
