...
import com.klein.cursomc.dto.ClienteDTO;
import com.klein.cursomc.dto.ClienteNewDTO;
...
public class ClienteService {
	...
	public Cliente insert(Cliente obj) {
		obj.setId(null);
		obj = repo.save(obj);
		enderecoRepository.saveAll(obj.getEndderecos());
		return obj;
	}
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("Não é possivel excluir um cliente pois há pedisos relacionados.");
		}
	}
